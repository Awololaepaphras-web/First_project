...
import { useRealtimeLeaderboard } from '../src/hooks/useRealtimeRanking';
import { Award, TrendingUp, Users, Loader2 } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        <header className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-4xl font-black tracking-tighter uppercase italic">Engagement Leaderboard</h1>
          </div>
          <p className="text-gray-500 font-medium italic max-w-2xl">
            Real-time ranking of the most active scholars in the matrix based on engagement received in the last 24 hours.
          </p>
        </header>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 leading-relaxed font-medium italic">
                The leaderboard is calculated in real-time using a weighted matrix of likes, replies, bookmarks, and shares received on posts created within the last 24 hours. High-value interactions like shares and bookmarks carry more weight in the final score.
              </p>
            </div>
          </div>
        </footer>
