...
const GladiatorPool: React.FC<GladiatorPoolProps> = ({ user, onCommit }) => {
  ...
  const handleCommit = () => {
    if ((user.points || 0) < points) {
      alert("Insufficient Prophy Coins for this level of combat.");
      return;
    }
    setLoading(true);
    setTimeout(() => {
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-6">
          ...
          <h1 className="text-5xl md:text-8xl font-black italic uppercase tracking-tighter leading-none">
            PROPHY COIN <span className="text-red-600">DROP</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-in fade-in slide-in-from-bottom-6 duration-700">
              <div className="bg-gray-900 p-10 rounded-[4rem] border border-gray-800 space-y-10 shadow-2xl relative overflow-hidden group">
                ...
                <div className="space-y-4 relative z-10">
                   ...
                   <p className="text-gray-500 font-medium text-sm">Contribute your Prophy Coins to the communal pot. Top gladiators split the combined pool + system bonus.</p>
                </div>
             ...
             <div className="space-y-6">
                ...
                <div className="p-8 bg-gray-800 rounded-[3rem] border border-gray-700 flex items-start gap-4">
                   ...
                   <div className="space-y-2">
                      ...
                      <p className="text-xs text-gray-400 font-medium leading-relaxed italic">Prophy Coins committed to the Prophy Coin Drop are non-refundable. Only the highest ranking nodes in the session will receive a cut of the total spoils.</p>
                   </div>
                </div>
             </div>
          </div>
